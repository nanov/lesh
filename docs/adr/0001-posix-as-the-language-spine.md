...
FAILs if a recorded expectation stops holding. There are 43 such cases today.
...
`tests/spec/invocation.spec` - 21 of the 43, chiefly the `getopts` state rules, the
