...
FAILs if a recorded expectation stops holding. There are 70 such cases today.
...
`tests/spec/invocation.spec` - 21 of the 70, chiefly the `getopts` state rules, the
