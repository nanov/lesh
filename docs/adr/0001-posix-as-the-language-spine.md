...
FAILs if a recorded expectation stops holding. There are 30 such cases today.
...
`tests/spec/invocation.spec` - 21 of the 30, chiefly the `getopts` state rules, the
