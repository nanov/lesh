...
FAILs if a recorded expectation stops holding. There are 35 such cases today.
...
`tests/spec/invocation.spec` - 21 of the 35, chiefly the `getopts` state rules, the
