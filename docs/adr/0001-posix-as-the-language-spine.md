...
FAILs if a recorded expectation stops holding. There are 32 such cases today.
...
`tests/spec/invocation.spec` - 21 of the 32, chiefly the `getopts` state rules, the
