...
FAILs if a recorded expectation stops holding. There are 34 such cases today.
...
`tests/spec/invocation.spec` - 21 of the 34, chiefly the `getopts` state rules, the
