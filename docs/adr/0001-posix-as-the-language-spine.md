...
FAILs if a recorded expectation stops holding. There are 74 such cases today.
...
`tests/spec/invocation.spec` - 21 of the 74, chiefly the `getopts` state rules, the
